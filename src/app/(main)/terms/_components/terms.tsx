...
const Terms = () => {
  return (
    <section className="w-full px-6 max-w-3xl mx-auto">
      ...
      <FadeIn delay={100}>
        <div className="text-[15px] text-[#52525b] space-y-5 leading-relaxed mb-8">
          <p>
          ...
          <p>
            <strong className="text-[#1a1a1f]">ARBITRATION NOTICE.</strong> Except for certain kinds of
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">1.2</strong> The Service uses artificial intelligence and machine learning to analyze data from various sources including phone calls, emails, and integrations with tools such as GitHub, Jira, Slack, and other platforms.</p>
            <p><strong className="text-[#1a1a1f]">1.3</strong> By using the Service, you acknowledge and agree that the technology used by Sentra is evolving, and subject to unexpected outputs and results. The suite of artificial intelligence tools used by Sentra may provide results that are inaccurate or information that does not accurately reflect real events, places, people, or facts.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">4.2 Authorization.</strong> You authorize Sentra to charge all sums for the orders that you make and any level of Service you select, including all applicable taxes, to the payment method specified in your account. If you pay any fees with a credit card, then Sentra may seek pre-authorization of your credit card account prior to your purchase to verify that the credit card is valid and has the necessary funds or credit available to cover your purchase.</p>
            <p><strong className="text-[#1a1a1f]">4.3 Subscription Service.</strong> The Service includes subscription-based plans with automatically recurring payments for periodic charges (&quot;Subscription Service&quot;). The Subscription Service will begin on the date when you purchase your first subscription to the Service and continue for the subscription period that you select on your account, and will automatically renew for successive periods unless you cancel the Subscription Service or we terminate it. Your account will be charged automatically on the renewal date of your Subscription Service for all applicable fees and taxes for the next Subscription Period. You must cancel your Subscription Service before it renews in order to avoid billing of the next periodic Subscription Fee to your account.</p>
            <p><strong className="text-[#1a1a1f]">4.4 Delinquent Accounts.</strong> Sentra may suspend or terminate access to the Service for any account for which any amount is due but unpaid. In addition to the amount due for the Service, a delinquent account will be charged with fees or charges that are incidental to any chargeback or collection of an unpaid amount, including collection fees.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">5.2 License Restrictions.</strong> Except as expressly authorized by Sentra, you may not: (a) reproduce, distribute, publicly display, publicly perform, or create derivative works of the Service; (b) make modifications to the Service; (c) interfere with or circumvent any feature of the Service, including any security or access control mechanism; (d) decompile, disassemble, reverse engineer, or otherwise examine, or attempt to derive the source code of the Service; or (e) use the Service for purposes of training any large language models, algorithms, or other software products or services without our express permission.</p>
            <p><strong className="text-[#1a1a1f]">5.3 Feedback.</strong> If you choose to provide feedback regarding any aspect or functionality of the Service, then you hereby grant Sentra an unrestricted, perpetual, irrevocable, non-exclusive, fully-paid, royalty-free right and license to use and exploit the feedback, in whole or in part, in any manner and for any purpose, including to improve the Service and create other products and services.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">8.2 Limited License Grant to Sentra.</strong> By providing User Content to or via the Service, you grant Sentra a worldwide, non-exclusive, irrevocable, royalty-free, fully paid right and license (with the right to sublicense through multiple tiers) to host, store, transfer, display, perform, reproduce, modify for the purpose of formatting for display, create derivative works as authorized in these Terms, and distribute your User Content, in whole or in part, in any media formats and through any media channels, in each instance whether now known or hereafter developed.</p>
            <p><strong className="text-[#1a1a1f]">8.3 You Must Have Rights to the Content You Provide.</strong> You must not provide User Content if you are not the owner of or are not fully authorized to grant rights in all of the elements of that User Content.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">9.2 Recording Consent.</strong> You are solely responsible for complying with all applicable laws regarding recording or monitoring communications. If you use Sentra to record, transcribe, or capture meeting content, you agree to provide all required notices and obtain any necessary consent from participants before doing so. Sentra does not control whether such consent is obtained and disclaims liability arising from a User&apos;s failure to comply with applicable recording laws.</p>
            <p><strong className="text-[#1a1a1f]">9.3 Local Recording Tools.</strong> If you use Sentra&apos;s desktop meeting note taker or other local recording tools, you acknowledge that recordings may capture audio or meeting content from your device or communication software. You are responsible for ensuring that all meeting participants are informed and that your use complies with applicable laws.</p>
            <p><strong className="text-[#1a1a1f]">9.4 License to Process Meeting Content.</strong> You retain ownership of your meeting recordings, transcripts, and related content. By using the Service, you grant Sentra a limited license to process, store, and analyze meeting recordings, transcripts, and related content solely for the purpose of providing and improving the Service. We do not use customer meeting content to train generalized AI models unless explicitly permitted.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">10.2 Email.</strong> We may send you emails concerning our products and services, as well as those of third parties, and you consent to the receipt of such emails. You may opt out of promotional emails by following the unsubscribe instructions in the promotional email itself.</p>
          </div>
        </div>
      </FadeIn>
        ...
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Use the Service to spread or generate misleading or false information;</li>
              ...
              <li>Sell or otherwise transfer the access granted under these Terms or any Materials or any right or ability to view, access, or use any Materials;</li>
              <li>Attempt to do any of the prohibited acts described in this Section 11, or assist or permit any person in engaging in any of the prohibited acts described in this Section 11.</li>
            </ul>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">12.2 DMCA Notification.</strong> We comply with the provisions of the Digital Millennium Copyright Act applicable to Internet service providers (17 U.S.C. § 512, as amended). If you have an intellectual property rights-related complaint about any material on the Service, you may contact our Designated Agent at: Dynamis Labs, Inc., Attn: Legal Department (IP Notification), Email: support@sentra.app</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">13.2 Termination.</strong> If you violate any provision of these Terms, then your authorization to access the Service and these Terms automatically terminate. In addition, Sentra may, at its sole discretion, terminate these Terms or your account on the Service, or suspend or terminate your access to the Service, at any time for any reason or no reason, with or without notice, and without any liability to you arising from such termination.</p>
            <p><strong className="text-[#1a1a1f]">13.3 Effect of Termination.</strong> Upon termination of these Terms: (a) your license rights will terminate and you must immediately cease all use of the Service; (b) you will no longer be authorized to access your account or the Service; (c) you must pay Sentra any unpaid amount that was due prior to termination; and (d) all payment obligations accrued prior to termination will survive.</p>
            <p><strong className="text-[#1a1a1f]">13.4 Modification of the Service.</strong> Sentra reserves the right to modify or discontinue all or any portion of the Service at any time, temporarily or permanently, without notice to you. Sentra will have no liability for any change to the Service, including any paid-for functionalities of the Service, or any suspension or termination of your access to or use of the Service.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">15.2</strong> THE SERVICE AND ALL MATERIALS AND CONTENT AVAILABLE THROUGH THE SERVICE ARE PROVIDED &quot;AS IS&quot; AND ON AN &quot;AS AVAILABLE&quot; BASIS. Sentra DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, RELATING TO THE SERVICE AND ALL MATERIALS AND CONTENT AVAILABLE THROUGH THE SERVICE.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">16.2</strong> THE AGGREGATE LIABILITY OF Sentra TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THE USE OF OR ANY INABILITY TO USE ANY PORTION OF THE SERVICE OR OTHERWISE UNDER THESE TERMS IS LIMITED TO THE GREATER OF: (a) THE AMOUNT YOU HAVE PAID TO Sentra FOR ACCESS TO AND USE OF THE SERVICE IN THE 12 MONTHS PRIOR TO THE EVENT OR CIRCUMSTANCE GIVING RISE TO THE CLAIM AND (b) US$100.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">YOU UNDERSTAND AND AGREE THAT, BY ENTERING INTO THESE TERMS, YOU AND Sentra ARE EACH WAIVING THE RIGHT TO A TRIAL BY JURY OR TO PARTICIPATE IN A CLASS ACTION.</strong></p>
            <p><strong className="text-[#1a1a1f]">17.2 Exceptions.</strong> Although we are agreeing to arbitrate most disputes between us, nothing in these Terms will be deemed to waive, preclude, or otherwise limit the right of either party to: (a) bring an individual action in small claims court; (b) pursue an enforcement action through the applicable federal, state, or local agency if that action is available; (c) seek injunctive relief in a court of law in aid of arbitration; or (d) to file suit in a court of law to address an intellectual property infringement claim.</p>
            <p><strong className="text-[#1a1a1f]">17.3 Opt-Out.</strong> If you do not wish to resolve disputes by binding arbitration, you may opt out of the provisions of this Section 17 within 30 days after the date that you agree to these Terms by sending a letter to Dynamis Labs, Inc., Attention: Legal Department - Arbitration Opt-Out, that specifies: your full legal name, the email address or phone number associated with your account on the Service, and a statement that you wish to opt out of arbitration.</p>
          </div>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        <div className="border-t border-[#e8e8ec] pt-10 mb-10">
          ...
          <div className="text-[15px] text-[#52525b] space-y-4 leading-relaxed">
            ...
            <p><strong className="text-[#1a1a1f]">18.2 Governing Law.</strong> These Terms are governed by the laws of the State of California without regard to conflict of law principles. You and Sentra submit to the personal and exclusive jurisdiction of the state courts and federal courts located within Santa Clara County, California for resolution of any lawsuit or court proceeding permitted under these Terms.</p>
            <p><strong className="text-[#1a1a1f]">18.3 Privacy Policy.</strong> Please read the Sentra Privacy Policy carefully for information relating to our collection, use, storage, and disclosure of your personal information. The Sentra Privacy Policy is incorporated by this reference into, and made a part of, these Terms.</p>
            <p><strong className="text-[#1a1a1f]">18.4 Contact Information.</strong> The Service is offered by Dynamis Labs, Inc. You may contact us by sending correspondence to that address or by emailing us at: support@sentra.app</p>
          </div>
        </div>
      </FadeIn>
    </section>
