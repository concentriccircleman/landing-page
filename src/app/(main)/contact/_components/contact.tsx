          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 border-l border-[#e8e8ec] p-8 md:p-14 bg-[#fafafa]">
            <label className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full h-10 bg-white text-[#1a1a1f] border border-[#e0e0e3] shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] px-4 py-2 text-sm placeholder:text-[#a1a1aa] focus:outline-none focus:border-brand focus:ring-1 focus:ring-[rgba(37,149,238,0.15)] transition-colors duration-150 rounded-sm"
                autoComplete="email"
                type="email"
                required
              />
            ...
            <label className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="w-full min-h-32 max-h-64 bg-white text-[#1a1a1f] border border-[#e0e0e3] shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] px-4 py-3 text-sm placeholder:text-[#a1a1aa] focus:outline-none focus:border-brand focus:ring-1 focus:ring-[rgba(37,149,238,0.15)] transition-colors duration-150 resize-y rounded-sm"
