    ...
    <section className="flex flex-col justify-center items-center text-black  pointer-events-none h-full content-gradient">
      <div className="px-8 max-w-3xl z-10 flex flex-col h-full w-full justify-center items-center pointer-events-auto overflow-y-auto">
        ...
        >
          ...
          <ul className="text-base text-black/80 mb-4 list-disc list-inside space-y-2">
          ...
          <h2 className="text-xl font-medium text-black mb-4">Your Choices</h2>
          ...
          <h2 className="text-xl font-medium text-black mb-4">Security</h2>
