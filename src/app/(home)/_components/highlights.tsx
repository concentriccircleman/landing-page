...
export default function Highlights() {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto w-full px-4">
      ...
      <div className="relative overflow-hidden border border-[#d4d4d8] bg-[#f8f8f8] rounded-sm">
          ...
          >
            <div className="flex-1 order-2 md:order-1">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-brand flex items-center justify-center flex-shrink-0 rounded-sm">
                  {active.icon}
                </div>
