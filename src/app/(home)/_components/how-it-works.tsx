...
const CAPABILITIES = [
  ...
  },
  {
    ...
    number: "02",
    description:
      "Conflicting priorities and missed commitments get flagged before they become problems.",
    icon: (
      <svg className="w-4 h-4 text-[#f0f0f0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: "agents",
    label: "Agents that work for you",
    number: "03",
    description:
  ...
  return (
    <section className="relative bg-[#f8f8f8] py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full px-4">
        ...
        <FadeIn delay={100}>
          <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-semibold tracking-tighter text-[#1a1a1f] leading-[1.1] max-w-4xl mb-16">
        ...
        <FadeIn delay={200}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {CAPABILITIES.map((capability) => (
              <IsometricCard key={capability.id} className="border border-[#e0e0e3] bg-[#f8f8f8] p-8 relative">
                <span
                  className="absolute top-6 right-6 font-semibold tabular-nums select-none pointer-events-none text-[#e8e8ec]"
