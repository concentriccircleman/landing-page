...
const AnnouncementBanner = ({ message }: AnnouncementBannerProps) => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[length:200%_100%] bg-[linear-gradient(90deg,transparent_0%,rgba(37,149,238,0.06)_25%,rgba(37,149,238,0.12)_50%,rgba(37,149,238,0.06)_75%,transparent_100%)] animate-[shimmer_4s_ease-in-out_infinite]" />
